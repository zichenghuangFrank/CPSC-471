...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 07, 2018 at 09:25 PM
...
('110110', 20, 'On earth', '100.00', 'Tim', 'Ben', '110110'),
('119', 19, 'Calgary', '195.24', 'Dry', 'Cananda', '123'),
('12345677', 20, 'University Dr NW, Calgary, Alberta', '999955.33', 'on', 'cyth', 'qwertyui'),
('30026610', 21, 'University Dr NW, Calgary, Alberta', '391.03', 'Ding', 'Jianan', '1111100000');
...
(11, 'Head & Shoulders MEN Full & Thick Dandruff 2-in-1 ', 3700088070, '12345677', '8.97'),
(4, 'Head & Shoulders MEN Full & Thick Dandruff 2-in-1 ', 3700088070, '30026610', '8.97'),
(4, 'Pantene Pro-V Daily Moisture Hydrating Renewal Shampoo And Conditioner Dual Value Pack', 8087807145, '119', '8.98'),
(1, 'LEGO Ideas LEGO NASA Apollo Saturn V (21309) Toy', 67341927715, '-1', '149.99'),
(1, 'LEGO Ideas LEGO NASA Apollo Saturn V (21309) Toy', 67341927715, '110110', '149.99'),
(3, 'Funko POP! Games: Fortnite - Black Knight Vinyl Figure Toy', 88969834467, '30026610', '12.94');
...
('Dove Sensitive Skin Moisturizing Cream Beauty bar', 6723885390, ''),
('Dove Sensitive Skin Moisturizing Cream Beauty bar', 6723885390, '12345677'),
('LEGO Ideas LEGO NASA Apollo Saturn V (21309) Toy', 67341927715, '30026610'),
('Funko POP! Games: Fortnite - Black Knight Vinyl Figure Toy', 88969834467, '119');
...
--
ALTER TABLE `order_history`
  ADD CONSTRAINT `order_history_ibfk_1` FOREIGN KEY (`User_id`) REFERENCES `client` (`User_id`);

--
-- Constraints for table `shopping_cart`
--
ALTER TABLE `shopping_cart`
  ADD CONSTRAINT `shopping_cart_ibfk_1` FOREIGN KEY (`Bar_code`) REFERENCES `products` (`Bar_code`);

--
-- Constraints for table `wish_list`
--
ALTER TABLE `wish_list`
  ADD CONSTRAINT `wish_list_ibfk_1` FOREIGN KEY (`Bar_code`) REFERENCES `products` (`Bar_code`);
COMMIT;
